...
class User:
    ...
    diocese: str = '', sexe: str = '', person_contacter_name: str = '', paroisse: str = '',
    person_contacter_phone: str = ''):
        ...
        self.sexe = sexe
        self.person_contacter_name = person_contacter_name
        self.person_contacter_phone = person_contacter_phone
